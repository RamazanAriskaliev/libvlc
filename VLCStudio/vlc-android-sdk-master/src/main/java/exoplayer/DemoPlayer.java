...
public class DemoPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  public interface RendererBuilder {
     ...
     *
     * @param player The player for which renderers are being built. {@link exoplayer.DemoPlayer#onRenderers}
     *     should be invoked once the renderers have been built. If building fails,
     *     {@link exoplayer.DemoPlayer#onRenderersError} should be invoked.
     */
    void buildRenderers(exoplayer.DemoPlayer player);
    /**
     * Cancels the current build operation, if there is one. Else does nothing.
     * <p>
     * A canceled build operation must not invoke {@link exoplayer.DemoPlayer#onRenderers} or
     * {@link exoplayer.DemoPlayer#onRenderersError} on the player, which may have been released.
     */
    void cancel();
  }
   ...
   *
   * @param renderers Renderers indexed by {@link exoplayer.DemoPlayer} TYPE_* constants. An individual

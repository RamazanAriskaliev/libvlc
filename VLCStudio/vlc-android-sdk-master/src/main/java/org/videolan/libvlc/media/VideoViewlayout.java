 ...
 */
public class VideoViewlayout extends FrameLayout implements ScreenObserver.ScreenStateListener{
    private static VideoView mVideoView;//视频播放窗口
    ...
    private static TextView mVoiceText,mCurrentTimeText, mTotalTimeText;//显示声音大小,播放的当前时间和总时间
    private static Button mPlayBtn;//播放暂停按钮
    private static SeekBar mSeekBar, mVoiceBar;//视频播放进度条,声音进度条
    ...
    private static ImageButton replayButton;//重播按钮
    ...
    private static boolean isPause,isBackOrHome = false;//是否是暂停状态,是否是切换回来的
    ...
    private static VoiceThread voiceThread;
    private static boolean surfaceCreated = false;
    //private static TimeThread timeThread;
    //private static VoiceThread voiceThread;

    /* 构造方法 */
    public VideoViewlayout(Context context, Application application, org.videolan.libvlc.MediaPlayer player, LibVLC libvlc, String videoUrl, String videoTitle, int[] array_position, boolean isVip,String slotId) {
        super(context);
   ...
   * vlc播放窗口关联及监听回调，播放器播放事件回调设置
   */
    public void setDisplayReplay() {
        if (mMediaPlayer != null) {
            log.i("setDisplay", "setDisplay");
            mMediaPlayer.setEventListener(mPlayerListener);
        }
    }
    ...
    */
    private void initToolLayout() {
        ...
        mPlayBtnLayout.setLayoutParams(llParams2);
        mCurrentTimeText = new TextView(mContext);
        ...
        mPlayBtnLayout.setLayoutParams(llParams2);
        mTotalTimeText = new TextView(mContext);
        ...
        mVoiceBar = new VerticalSeek(mContext);
        ...
        //重播
        FrameLayout.LayoutParams replayparam = new FrameLayout.LayoutParams(mScreenWidth / 8, mScreenWidth / 8);
        replayparam.gravity = Gravity.CENTER;
        replayButton = new ImageButton(mContext);
        replayButton.setLayoutParams(replayparam);
        replayButton.setBackgroundResource(R.drawable.replay);
        this.addView(replayButton);
    ...
    */
    static IVLCVout.Callback callback = new IVLCVout.Callback() {
        ...
        public void onSurfacesCreated(IVLCVout vlcVout) {
            ...
            mSeekBar.setProgress((int)mLastExitTimem);
        }
        ...
        public void onEvent(org.videolan.libvlc.MediaPlayer.Event event) {
            switch (event.type) {
                case org.videolan.libvlc.MediaPlayer.Event.Playing:
                    ...
                    mSeekBar.setMax((int) mTotalTime);
                    mCurrentTimeText.setText(DateUtil.formatTime(mMediaPlayer.getTime()));
                    mTotalTimeText.setText(DateUtil.formatTime(mMediaPlayer.getLength()));
                    break;
                ...
                case org.videolan.libvlc.MediaPlayer.Event.EndReached:
                    log.i("Event5", "MediaPlayerEndReached");
                    mLoadingIcon.setVisibility(View.GONE);
                    showReplay();
                    break;
                default:
   ...
   */
    ...
    */
    private class OnSeekBarChangeListenerImp implements
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            ...
            VideoViewlayout.mHandlerSeekbar.sendEmptyMessage(Constants.VIDEOBARSTOP);
        }
    }
    ...
    */
    ...
    class MyTimerTask extends TimerTask {
        ...
        public void run() {
            ...
            mHandler.sendEmptyMessage(Constants.HIDETOOLS);
            mHandler.sendEmptyMessage(Constants.UPDATETIME);
        }
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                case Constants.UPDATETIME:
                    ...
                    //if (!isProgressing) {
                        mCurrentTimeText.setText(mCurTimeStr);
                    //}
                    mSeekBar.setProgress((int) mCurTime);
                    break;
    ...
    * 静态handler处理声音进度任务
    */
    public static Handler mHandlerSeekbar = new Handler(new Handler.Callback() {
        @Override
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case Constants.VIDEOBARSTOP:
                    ...
                    mCurrentTimeText.setText(DateUtil.formatTime(mVideo));
    ...
    */
    ...
    public void setFullClick(CallBackScreen callBackScreen){
        this.callBackScreen = callBackScreen;
    }

    public void full(boolean isReverse) {
        callBackScreen.fullClick();
        if (isReverse) {
    ...
    public void shutdownObserver(){
        mHandler.sendEmptyMessage(Constants.SHUTOBSERVEER);
    }

 ...
 * 自定义垂直seekbar
 */
public class VerticalSeek extends SeekBar
{
    ...
    public VerticalSeek(Context context, AttributeSet attrs, int defStyle)
    {
    ...
    public VerticalSeek(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    }
    ...
    void onStopTrackingTouch()
    {
        ...
        VideoViewlayout.mHandlerSeekbar.sendMessage(msg);
    }
